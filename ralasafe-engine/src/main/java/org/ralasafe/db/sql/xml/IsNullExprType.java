 ...
 * Schema.
 * $Id: IsNullExprType.java,v 1.1 2010/07/09 08:17:05 back Exp $
 */
...
/**
 * Class IsNullExprType.
 * 
 * @version $Revision: 1.1 $ $Date: 2010/07/09 08:17:05 $
 */
public class IsNullExprType implements java.io.Serializable {
     ...
     * Field _variable.
     */
    private org.ralasafe.db.sql.xml.Variable _variable;
    ...
    public void setVariable(
            final org.ralasafe.db.sql.xml.Variable variable) {
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.ralasafe.db.sql.xml.IsNullExprType) Unmarshaller.unmarshal(org.ralasafe.db.sql.xml.IsNullExprType.class, reader);
    }
