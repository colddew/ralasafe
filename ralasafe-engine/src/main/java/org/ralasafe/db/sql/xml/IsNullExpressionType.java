 ...
 * Schema.
 * $Id: IsNullExpressionType.java,v 1.1 2010/07/09 08:17:06 back Exp $
 */
...
/**
 * Class IsNullExpressionType.
 * 
 * @version $Revision: 1.1 $ $Date: 2010/07/09 08:17:06 $
 */
public class IsNullExpressionType implements java.io.Serializable {
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.ralasafe.db.sql.xml.IsNullExpressionType) Unmarshaller.unmarshal(org.ralasafe.db.sql.xml.IsNullExpressionType.class, reader);
    }
