...
public class SimpleValueType implements java.io.Serializable {
    ...
    public SimpleValueType() {
        super();
        setContent("");
        setType(org.ralasafe.db.sql.xml.types.SimpleValueTypeTypeType.valueOf("string"));
    }

    public SimpleValueType(final java.lang.String defaultValue) {
        try {
     ...
     */
    public void setType(
            final org.ralasafe.db.sql.xml.types.SimpleValueTypeTypeType type) {
        this._type = type;
    }
