 ...
 * Schema.
 * $Id: WhereType.java,v 1.2 2010/07/29 02:41:59 back Exp $
 */
 ...
 */
public class WhereType implements java.io.Serializable {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.ralasafe.db.sql.xml.WhereType
     */
    public static org.ralasafe.db.sql.xml.WhereType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.ralasafe.db.sql.xml.WhereType) Unmarshaller.unmarshal(org.ralasafe.db.sql.xml.WhereType.class, reader);
    }
