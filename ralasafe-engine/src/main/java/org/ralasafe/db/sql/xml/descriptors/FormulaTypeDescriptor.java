...
public class FormulaTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FormulaTypeDescriptor() {
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(org.ralasafe.db.sql.xml.types.FormulaTypeOperatorType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("FormulaTypeOperatorType");
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(org.ralasafe.db.sql.xml.types.FormulaTypeTypeType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("FormulaTypeTypeType");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setComponentType("org.ralasafe.db.sql.xml.Variable");
        desc.setHandler(handler);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.ralasafe.db.sql.xml.FormulaType.class;
    }
