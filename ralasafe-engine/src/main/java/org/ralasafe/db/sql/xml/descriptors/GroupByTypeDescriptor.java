 ...
 * Schema.
 * $Id: GroupByTypeDescriptor.java,v 1.1 2010/07/09 08:17:18 back Exp $
 */
...
import org.ralasafe.db.sql.xml.GroupByType;

/**
 * Class GroupByTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2010/07/09 08:17:18 $
 */
public class GroupByTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GroupByTypeDescriptor() {
        super();
        _xmlName = "GroupByType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GroupByType target = (GroupByType) object;
        ...
        desc.setComponentType("org.ralasafe.db.sql.xml.Column");
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.ralasafe.db.sql.xml.GroupByType.class;
    }
